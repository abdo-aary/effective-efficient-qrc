...
% Make algorithm comments right-aligned and italic, clearly separated from the numbered steps
...
\newcommand{\HT}{H^T}
\newcommand{\HTh}{\HT_h}
\newcommand{\gTIFMP}{\gT(\gI)_{\scriptscriptstyle \rm FMP}}
...
\newcommand{\Nfft}{N_{\rm fft}}

\newcommand{\gDnor}{\gD_{\rm nor}}
\newcommand{\gDab}{\gD_{\rm ab}}
\newcommand{\Pnor}{P_{\rm nor}}

\DeclareMathOperator{\tr}{\scriptscriptstyle tr}
\DeclareMathOperator{\ts}{\scriptscriptstyle ts}

\DeclareMathOperator{\qc}{qc}
\DeclareMathOperator{\params}{params}
\DeclareMathOperator{\pub}{pub}
\DeclareMathOperator{\pubs}{pubs}
\DeclareMathOperator{\supp}{supp}
\DeclareMathOperator{\FMP}{FMP}
\newcommand{\gFMP}{\gF_{\FMP}}

% "parallel for ... do ... end parallel for"
