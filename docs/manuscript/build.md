...
Run from the manuscript project:
...
- `../manuscript/theory-audit.md`: concise audit of the revised theorem dependency chain.
- `../architecture/implementation-contract.md`: theorem-to-code contract freezing data indexing,
  initialization, measurement, readout, selection, paired randomness, and
  empirical-gap semantics.
- `../../experiments/empirical_evaluation/experiment_contract.yaml`: executable companion contract
