...
TSER_DATASETS: dict[str, TSERDatasetSpec] = {
    ...
    "manganese_concentration": TSERDatasetSpec(
        key="manganese_concentration",
        record_id="11236670",
        dataset_name="ManganeseConcentration",
        train_file="ManganeseConcentration_TRAIN.ts",
        test_file="ManganeseConcentration_TEST.ts",
        description="Spectroscopy trajectory -> scalar manganese concentration.",
    ),
    "iron_concentration": TSERDatasetSpec(
        key="iron_concentration",
        record_id="11236615",
        dataset_name="IronConcentration",
        train_file="IronConcentration_TRAIN.ts",
        test_file="IronConcentration_TEST.ts",
        description="Spectroscopy trajectory -> scalar iron concentration.",
    ),
    "copper_concentration": TSERDatasetSpec(
        key="copper_concentration",
        record_id="11235478",
        dataset_name="CopperConcentration",
        train_file="CopperConcentration_TRAIN.ts",
        test_file="CopperConcentration_TEST.ts",
        description="Spectroscopy trajectory -> scalar copper concentration.",
    ),
    "gas_sensor_array_acetone": TSERDatasetSpec(
        key="gas_sensor_array_acetone",
        record_id="11235589",
        dataset_name="GasSensorArrayAcetone",
        train_file="GasSensorArrayAcetone_TRAIN.ts",
        test_file="GasSensorArrayAcetone_TEST.ts",
        description="Gas sensor array trajectories -> scalar acetone concentration.",
    ),
    "gas_sensor_array_ethanol": TSERDatasetSpec(
        key="gas_sensor_array_ethanol",
        record_id="11235596",
        dataset_name="GasSensorArrayEthanol",
        train_file="GasSensorArrayEthanol_TRAIN.ts",
        test_file="GasSensorArrayEthanol_TEST.ts",
        description="Gas sensor array trajectories -> scalar ethanol concentration.",
    ),
    "electric_motor_temperature": TSERDatasetSpec(
        key="electric_motor_temperature",
        record_id="11235562",
        dataset_name="ElectricMotorTemperature",
        train_file="ElectricMotorTemperature_TRAIN.ts",
        test_file="ElectricMotorTemperature_TEST.ts",
        description="Electric motor operating trajectories -> scalar motor temperature.",
    ),
}
